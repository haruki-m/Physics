...
thk = 0.2
start_height = 0
ball = sphere(pos=(0,rad+thk/2 + start_height,0), radius = rad, color=color.white)
...
initialRocketMass=ball.mass 
initialPressure = 45 * 6894.75729 ## pascals
initialAirVolume = (2-waterMass)/1000 ## 
bottleNeck = .011 ##m
...
print("Final Pressure inside Rocket: %4.2f" % PT + " psi")
